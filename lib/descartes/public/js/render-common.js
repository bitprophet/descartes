...
var constructGraphUrl = function(graph) {
  ...
  var authBlob = "";
  if (graphiteUser.length != 0 && graphitePass.length != 0) {
      authBlob = graphiteUser + ':' + graphitePass + '@';
    }
  myAuthUrl = myParseUrl.protocol + '://' + authBlob + myParseUrl.host + ':' + myParseUrl.port;
